...
Fmax = 105.7  # [N]
Fmin = 12.24  # [N]
spring = HelicalPushSpring(force=Fmax, Ap=Ap, m=m, yield_percent=yield_percent, wire_diameter=d,
                           spring_diameter=D, shear_modulus=G, end_type='squared and ground',
                           spring_constant=None, active_coils=21, free_length=L0, set_removed=False,
                           shot_peened=False)
