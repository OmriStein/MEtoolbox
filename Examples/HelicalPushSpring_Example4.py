...
d, D, K, Na = symbols('d, D, K, Na', real=True, positive=True)
...
# wire_sizes_inch = [0.069, 0.071, 0.080, 0.085, 0.090, 0.095, 0.105, 0.112]
...
# C = spring.CalcSpringIndex(1.2)
# d = 0.08*25.4
# spring.spring_diameter = spring.wire_diameter * C
spring.wire_diameter = 4
spring.spring_diameter = 40
